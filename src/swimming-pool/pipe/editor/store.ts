...
type PipeEditState = {
  ...
  subSelection: PipeSubSelection | null
  ...
  clearExtension: () => void
  setSubSelection: (selection: PipeSubSelection | null) => void
...
export const usePipeEditStore = create<PipeEditState>((set) => ({
  ...
  setSubSelection: (subSelection) => set({ subSelection }),
