...
invariant(manifest.main === './src/index.ts', 'Package main entry must point to src/index.ts')
invariant(manifest.types === './src/index.ts', 'Package types entry must point to src/index.ts')
invariant(manifest.files?.includes('src'), 'Published files must include src')
